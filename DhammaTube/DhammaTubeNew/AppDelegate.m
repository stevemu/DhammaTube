...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //for pushing last playlist navigation
    [GlobalData setJustLaunched:YES]; //turn off for testing

   /* CGRect sr = [[UIScreen mainScreen] bounds];
    self.window = [[UIWindow alloc] initWithFrame:sr];*/

    //magical records
    [MagicalRecord setupCoreDataStackWithStoreNamed:@"dhamma"];
...
/*
    ...
    [GlobalData setViewViewController:detailedViewController];
